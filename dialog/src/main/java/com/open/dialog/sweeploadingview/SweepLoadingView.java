package com.open.dialog.sweeploadingview;
...
public class SweepLoadingView extends View {
    ...
    private void initObjectAnimation() {
        ...
        sweepObjectAnimator.setRepeatCount(Animation.INFINITE);
    ...
    private void setSweepAngle(float sweepAngle) {
        Log.i("wang","setSweepAngle : "+sweepAngle);
